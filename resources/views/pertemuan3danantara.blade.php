    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-9">
                <div>
                    <p></p>
                    <p class="open-sans-judul fontintro"><b>Danantara Indonesia</b> merupakan badan pengelola investasi yang menangani,
                        mengoptimalkan,
                        dan mengembangkan aset strategis Indonesia, sejalan dengan agenda jangka panjang transformasi
                        ekonomi nasional.</p>
                </div>
            </div>
            <div class="col-3">
